...
class HotelHttpTests {
    ...
    @Test
    fun should_synchronize_local_hotel_with_remote_server() {
        //Given
        val hotel = Hotel(name = "Ritz Recife", rating = 5.0f)
        authmanager_must_return_a_valid_user()
        local_hotel_have_one_item(hotel)
