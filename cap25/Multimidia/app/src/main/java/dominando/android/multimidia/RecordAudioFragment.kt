...
class RecordAudioFragment : MultimidiaFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        retainInstance = true
        val audioPath =
            MediaUtils.getLastMediaPath(requireContext(), MediaUtils.MediaType.MEDIA_AUDIO)
        if (audioPath != null) {
        ...
        if (mediaRecorder != null && isRecording) {
            ...
            audioFile?.let {
                MediaUtils.saveLastMediaPath(
                    requireContext(), MediaUtils.MediaType.MEDIA_AUDIO, it.absolutePath
                )
            }
        }
    }
